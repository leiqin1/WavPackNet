...
from sfm_learner.utils.image import load_image, gradient_x, gradient_y, flip_lr, interpolate_image
from sfm_learner.utils.types import is_seq, is_tensor
...
def post_process_inv_depth(inv_depth, inv_depth_flipped, method='mean'):
    ...
    """
    if inv_depth.dim() == 3:
        inv_depth.unsqueeze_(0)
    if inv_depth_flipped.dim() == 3:
        inv_depth_flipped.unsqueeze_(0)
