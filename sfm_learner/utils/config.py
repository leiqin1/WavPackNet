...
from sfm_learner.utils.logging import s3_url, prepare_dataset_prefix
from sfm_learner.utils.horovod import on_rank_0
from sfm_learner.utils.types import is_cfg, is_list
from sfm_learner.utils.misc import make_list
from sfm_learner.utils.load import load_class, backwards_state_dict
...
def parse_train_file(file, ckpt):
    """
    ...
    if file.endswith('yaml'):
        ...
        config = parse_train_config(cfg_default, file)
