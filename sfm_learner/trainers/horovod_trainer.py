...
try:
    ...
    HAS_HOROVOD = False
from sfm_learner.trainers.base_trainer import BaseTrainer, sample_to_cuda
from sfm_learner.utils.config import prep_logger_and_checkpoint
from sfm_learner.utils.logging import print_config
from sfm_learner.utils.logging import AvgMeter
...
class HorovodTrainer(BaseTrainer):
    def __init__(self, **kwargs):
        ...
        torch.cuda.set_device(hvd.local_rank() if HAS_HOROVOD else 0)
